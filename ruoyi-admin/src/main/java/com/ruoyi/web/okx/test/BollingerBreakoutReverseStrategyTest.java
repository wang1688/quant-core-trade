...
import com.ruoyi.web.okx.strategy.BollingerBreakoutReverseStrategy;
import com.ruoyi.web.okx.util.OkxKlineUtil;
import com.ruoyi.web.okx.vo.KLineVO;
import java.util.List;

public class BollingerBreakoutReverseStrategyTest {
    public static void main(String[] args) throws Exception {
        List<KLineVO> klist = OkxKlineUtil.parseKline(OkxKlineUtil.getOkxKline());
        KLineVO[] k15m = klist.toArray(new KLineVO[0]);
        BollingerBreakoutReverseStrategy s = new BollingerBreakoutReverseStrategy();
